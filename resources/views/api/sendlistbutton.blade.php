...
<div id="accordionPayment" class="accordion">
    <div class="card">
        <div class="card-body">
            ...
            <span class="text-info">Download Example PHP :</span> <a class="fw-bold" target="_blank"
                href="https://www.mediafire.com/file/8v33px0i5mm5v8o/example-rest-api.zip/file">Download</a><br>
            ...
            <div class="card accordion-item mt-3">
                <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" aria-expanded="true"
                        data-bs-target="#sendtext-array" aria-controls="accordionPayment-1">
                        Array Body
                    </button>
                </h2>
  ...
  "data": {
    ...
    "footer": "WHATSAPP ZOFTWARE - WHATSAPP ZOFTWARE",
    "buttonText": "Click Me",
    "sections": [
        {
            "title": "Section 1",
        ...
        },
        {
            ...
            <div class="card accordion-item mt-3">
                <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" aria-expanded="true"
                        data-bs-target="#sendtext-curl" aria-controls="accordionPayment-1">
                        Code Example Curl
                    </button>
                </h2>
