                ...
                <div class="row">
                    <div class="col-12 col-xl-6 col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="receiver" class="form-control" autocomplete="off" required
                                placeholder="ex: 62857xxxxxx">
                        </div>
                    </div>
                    <div class="col-12 col-xl-6 col-lg-6">
                        <div class="mb-3">
    ...
    <script>
        ...
        $("#form-store-single").submit(function(e) {
            ...
            ilsya.ajax({
                ...
                addons_error: function(error) {
                    // Log de errores si es necesario
