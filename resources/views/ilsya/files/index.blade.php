    ...
    <div class="card">
        <nav class="navbar navbar-expand-lg bg-navbar-theme">
            <div class="container-fluid">
                ...
                <a class="text-dark d-block d-lg-none" href="javascript:void(0)" data-bs-toggle="collapse"
                    ...
                    <ul class="navbar-nav ms-lg-auto">
                        <li class="nav-item">
                            <label class="btn btn-primary">
                                <i class="tf-icons navbar-icon ti ti-cloud-upload ti-xs me-1"
                                    style="margin-top: -2px;"></i> Uplaod Files
        ...
        <div class="card-body bg-lighter" id="app-ilsya-files-content"
            style="height: calc(100vh - 12rem) !important; overflow: auto;">
            <div class="row row-cols-2 row-cols-xl-5 row-cols-md-4 row-cols-sm-2 g-2">
                @foreach ($files as $file)
                    <div class="col">
                        <div class="card mb-2 getfiles-ilsya" data-url="{!! route('storage', 'url=' . $file['path']) !!}"
                            data-path="{!! $file['path'] !!}" data-mime="{{ $file['mime'] }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data-path=""
                        class="btn btn-label-danger is-btn-delete-ilsya">Delete</button>
                </div>
            </div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.data.mime == 'image') {
                        content = '<img class="cover-ilsya rounded" src="{!! route('storage') !!}?url=' +
                            data.data.path + '" alt="">'
                    } else {
                        content =
                            '<div class="cover-ilsya rounded d-flex align-items-center justify-content-center"><span class=" text-muted">' +
                            data.data.ext + '</span></div>'
                    }
                    var html = `
                    <div class="col">
