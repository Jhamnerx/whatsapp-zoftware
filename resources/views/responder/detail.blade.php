                    ...
                    <div class="col-12 col-xl-6 col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="keyword" class="form-control" autocomplete="off"
                                value="{{ $row->keyword }}" required placeholder="ex: !help">
                        </div>
                    </div>
                    <div class="col-12 col-xl-6 col-lg-6">
                        <div class="mb-3">
                    ...
                    <div class="col-12 col-xl-6 col-lg-6">
                        <div class="mb-3">
                            ...
                            <select name="type_keyword" required class="form-select">
                                ...
                                <option {{ $row->type_keyword == 'contains' ? 'selected' : '' }} value="contains">Contain
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-xl-6 col-lg-6">
                        <div class="mb-3">
                            ...
                            <select name="reply_when" required class="form-select">
                                ...
                                <option {{ $row->reply_when == 'personal' ? 'selected' : '' }} value="personal">Personal
                                </option>
                    ...
                    <div class="col-12 col-xl-6 col-lg-6"">
                        <div class="mb-3">
                            ...
                            <select name="status" required class="form-select">
                                ...
                                <option {{ $row->status == 'inactive' ? 'selected' : '' }} value="inactive">InActive
                                </option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-xl-6 col-lg-6">
                            <div class="mb-3"><label class="form-label">Media</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{ $data->url }}" name="media"
                                        required>
                                    <button class="btn btn-primary waves-effect filemanagerilsya"
                                        type="button">Uploade</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-6 col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">Media Mime</label><select name="media_type" required
                                    class="form-select">
                    ...
                    @elseif ($row->message_type == 'button')
                        ...
                        <div class="col-12">
                            <div class="table_button_message table-btn">
                                <div class="text-end"><button type="button" class="btn btn-label-primary is-add">Add
                                        Button</button></div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody class="table-border-bottom-0 is-content">
                                            @foreach ($data->buttons as $btn)
                                                <tr>
                                                    <td><input type="text" name="btn_display[]" class="form-control"
                                                            required value="{{ $btn->display ?? '' }}"></td>
                                                    <td><input type="text" name="btn_id[]" class="form-control"
                                                            required value="{{ $btn->id ?? '' }}"></td>
                                                    <td><button class="btn btn-label-danger is-delete" type="button"><i
                                            ...
                                            @foreach ($data->sections as $btn)
                                                @isset($btn->title)
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="btn_display[]" class="form-control"
                                                                value="{{ $btn->title }}" placeholder="Ex: Menu Click Me"
                                                                required=""></td>
                                                        <td data-input-btn-id>
                                                            <input style="display: none" type="text" name="btn_id[]"
                                                ...
                                                @foreach ($btn->rows as $row)
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="btn_display[]"
                                                                class="form-control" value="{{ $row->title }}"
                                                                placeholder="Ex: Menu Click Me" required=""></td>
                                                        <td data-input-btn-id><input type="text" name="btn_id[]"
                                                                value="{{ $row->rowId }}" placeholder="Ex: !menu"
                                                                class="form-control" required=""></td>
                                                        <td><button class="btn btn-label-danger is-delete"
